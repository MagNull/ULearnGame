# Concept
 Bullet hell про файты с боссами(aka Monster Hunter).
## Gameplay
...
## Combat
  У игрока в арсенале 2 способа нанесения урона(мили и рэндж) и 2 абилка: временная неуязвимость aka додж и короткий блинк.
## Boss
  Каждый босс имеет несколько фаз. При смерти во время сражения игрок откатывается обратно в лобби. 
  Боссов можно проходить подряд тем самым увеличивая сложность последующих и качество их лута.
# Implementation
## Player
